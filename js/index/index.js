...
function createStar() {
  ...
  var angle = Math.atan(
    ((ileft - fleft) * window.innerWidth) /
      100 /
      (((ibottom - fbottom) * window.innerHeight) / 100)
  );
  if (fbottom > ibottom) {
    angle += Math.PI;
  }
  ...
  star.style =
    ...
    ";--right_line_color:" +
    randomColor() +
    ";--first_center_line_color:" +
    randomColor() +
    ";--second_center_line_color:" +
    randomColor() +
    ";--third_center_line_color:" +
    randomColor() +
    ";--fourth_center_line_color:" +
    randomColor() +
    ";--degree:" +
    angle +
    "rad;--ileft:" +
